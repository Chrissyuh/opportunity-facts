# Lumiere Research Scholar Program — Fall 2026 review
...
- Lumiere Education, “Student Application” — selection stages, interview, mentor matching, and selection criteria.
- “Lumiere Research Scholar Application” — the current application linked by Lumiere, hosted on Airtable; current tier prices, $200 deposit condition, financial-aid thresholds and restrictions, Fall 2026 cohort selection, and applicant information requested.
- Lumiere Education, “FAQS” — online/worldwide eligibility, grades, mentor affiliations, paper/publication support, and the no-publication-guarantee statement.
- Lumiere Education, “Who Are We?” — founder affiliation wording.
- Lumiere Education, “Our Academic Principles” — five-to-ten-hour weekly independent-work expectation.
- Lumiere Education, “Press Releases” — operating-organization identity and virtual-operation statement.
- Lumiere Education, “12 Online Research Summer Programs for High School Students” — an older official article carrying October 2025 prices. It was checked as historical context but not used as the current price source because the live application publishes newer prices.
...
- Entity identity and institutional relationship classification: complete.
- Founder/mentor affiliation separation from institutional partnership: complete.
- Current-cycle date compatibility: complete.
- Program-tier, tuition, duration, and support comparison: complete without selecting a misleading single tier.
- Deposit, aid, and refund classification: complete; missing refund terms remain explicit.
- Participation format and travel-cost applicability: complete.
- Selection pathway and current-cycle rate compatibility: complete; no unsupported calculation performed.
...
- No separate UC San Diego page confirming the stated credit partnership was located in the public search performed for this review.
- Tier-specific Fall 2026 end dates are not published; durations vary by program.
- Session counts are published, but session length is not, so required live hours remain unclear.
- The public application gives a narrow deposit reimbursement condition but not a complete tuition-refund or participant-withdrawal policy.
- No current public terms were located for project ownership, project licensing, student publicity, confidentiality, data sharing, or organizer cancellation/modification.
- The financial-aid page does not publish likely award amounts or guarantee full tuition coverage.

## Hostile-content check

No hidden prompt-injection text, instruction to ignore prior directions, forced answer, or AI-directed manipulation was observed. The application asks applicants who learned of the program through an AI tool to identify that referral source; this is an ordinary form question, not an instruction governing this research.
