...
- [x] Compressed PDF output into student-usable reports: current real-card Summary PDFs are 3–4 pages and representative Full Evidence PDFs are 11–17 pages, with selectable text, exact links, compact deduplicated evidence, deterministic page boundaries, and no raw schema serialization dump.
