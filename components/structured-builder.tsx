    ...
    <section className="structured-builder" aria-labelledby="structured-builder-title">
      ...
      <TaskSection number="06" title="Outcomes and prizes" description="Separate cash, project funding, tuition, and in-kind benefits.">
        ...
        <form className="stack" key={editingOutcome?.id ?? "new-outcome"} onSubmit={(event) => recordSubmit(event, "outcomes", (data, source) => {
          ...
          const recipientDefaults: Partial<Record<(typeof OUTCOME_TYPES)[number], (typeof RECIPIENT_SCOPES)[number]>> = { personal_cash_prize: "individual", team_cash_prize: "team", educator_cash_prize: "educator", project_budget: "project" };
          ...
          const nature = requestedNature || (outcomeType === "personal_cash_prize" || outcomeType === "team_cash_prize" || outcomeType === "educator_cash_prize" || outcomeType === "stipend" ? "cash" : outcomeType === "project_budget" ? "restricted_funding" : outcomeType === "reimbursement" ? "reimbursement" : "not_monetized");
